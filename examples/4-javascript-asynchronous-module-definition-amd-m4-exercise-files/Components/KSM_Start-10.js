var WhichFooter = 'new', // Could be provided by a query string parameter
	footerLibrary = WhichFooter === 'new' ? 'Components/NEW/NEW_FooterAMD'
										  : 'Components/KSM/KSM_FooterAMD';
require.config( 
{
    baseUrl: './',
    paths: 
