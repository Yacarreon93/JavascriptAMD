/*  KSM_ToolbarAMD.js
*/
define(['jquery', 'KSM_ToolbarAMDDefaults', 'KSM_LanguageAMD', 'KSM_Config'], 
function($, 	   defaults, 				 language,			config)
{   var _KSM = { Language: language, defaultContext: config.defaultContext };
    $.extend(true, _KSM,
    {   Toolbar:
        {   version: '1.0',
            minorVersion: '2',
	...
	$.extend(true, _KSM.Toolbar, defaults);
	return _KSM.Toolbar;
})
