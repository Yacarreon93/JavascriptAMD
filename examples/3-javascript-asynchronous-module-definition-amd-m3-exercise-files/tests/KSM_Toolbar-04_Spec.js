define(['jquery', 'KSM_ToolbarAMD', 'KSM_LanguageAMD'], function($, toolbar, language)
{	var _KSM = 
	{	Toolbar: toolbar,
		Language: language
	};
	describe('These tests', function()
	{	it('should work with RequireJS loading Jasmine', function()
	...
	{	var theLib = _KSM.Toolbar.toolbarDiv,
		...
		describe('when called with buttons defined will', function()
		{	var toolbar = $(theLib(
				{	buttons: buttons
				})),
				$toolbarDiv = $(toolbar),
		...
		describe('when called with buttons defined and alternate titles will', function()
		...
		{	it('be able to find the language library', function()
			...
			it('have a translated title when requested', function(next)
